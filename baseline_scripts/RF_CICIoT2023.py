...
X_train, X_test, y_train, y_test = train_test_split(scaled_df, encoded_labels_bin, test_size=0.15, random_state=42)
...
X_train, X_test, y_train, y_test = train_test_split(scaled_df, encoded_labels, test_size=0.15, random_state=42)
...
X_train, X_test, y_train, y_test = train_test_split(scaled_df[selected_features], encoded_labels, test_size=0.15, random_state=42)
